...
def upload_file():
    ...
    try:
        ...
        # One-time migration: if blended data missing but dialer dates exist, force full reprocess
        if not stored.get("dialer_blended_by_day") and stored.get("processed_dates", {}).get("dialer"):
